...
def _model_available() -> bool:
    try:
        ...
        # Specifically MODEL, not "any granite": tau is calibrated per model, so
        # a suite that silently ran against a different one would pass without
        # exercising the thresholds the product actually ships with.
